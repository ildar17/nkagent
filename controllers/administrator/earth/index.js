        ...
        drop.dropRegion(function (err, result) {
          ...
          if (result == 0) {
            req.session.flash = {
              ...
              message: "Удаляемая область имеет связанные записи, удалите город затем область."
            };
            res.redirect(303, 'back');
        ...
        drop.dropCountry(function (err, result) {
          ...
          if (result == 0) {
            req.session.flash = {
              type: 'danger',
              intro: 'Ошибка администрирования!',
              message: "Удаляемая страна имеет связанные записи, удалите область затем страну."
            };
            res.redirect(303, 'back');
