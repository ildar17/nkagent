...
exports.list = function (req, res, next) {
  ...
  let tasks = [getSection, initialization, accessValue, userMenu, accessTemplate, editDistricts, editCity, dateEntry, existIdNode, listEdit, listDrop, editPublish, listDistricts, listCity, type, selectSection, sectionSorting, agentSelect, agentSorting, streetSelect, streetSorting, priceSelect, priceSorting, op, Balcony, project, toilet, status, main, listDrop, listTable, listRender];
