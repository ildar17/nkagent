...
exports.list = function (req, res, next) {
  ...
  let tasks = [getSection, initialization, accessValue, userMenu, accessTemplate, editDistricts, editCity, dateEntry, existIdNode, listEdit, listDrop, type, editPublish, listDistricts, listCity, agentSelect, agentSorting, selectSections, sectionSorting, streetSelect, streetSorting, priceSelect, priceSorting, status, main, listTable, listRender];
