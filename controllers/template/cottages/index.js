...
exports.list = function (req, res, next) {
  ...
  let tasks = [getSection, initialization, accessValue, userMenu, accessTemplate, editDistricts, editCity, dateEntry, existIdNode, listEdit, listDrop, type, editPublish, listDistricts, listCity, selectSections, sectionSorting, agentSelect, agentSorting, streetSelect, streetSorting, materialSelect, priceSelect, priceSorting, categoryLandSelect, status, main, listTable, listRender];
