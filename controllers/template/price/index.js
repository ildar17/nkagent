...
exports.list = function (req, res, next) {
  ...
  let tasks = [ getSection, initialization, accessValue, listAccess, typeSelect, sectionSelect, citySelect, streetSelect, agentSelect, opSelect, minMax, columnPrice, listTable, listRender ];
...
exports.submit = function (req, res, next) {
  ...
  function stringSQL() {
    ...
    if(value.button === '1'){
      ...
      let code = '';
      let arrPrice = ['type', 'section', 'city', 'street', 'house', 'liter', 'storey', 'project', 'price', 'area', 'toilet', 'balcony', 'op', 'note', 'agent'];
