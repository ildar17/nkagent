...
exports.submit = function (req, res, next) {
  ...
  let tasks = [getSection, initialization, accessValue, userMenu, accessTemplate, submitAccess, calculatePaymentPrice, submitValidate, getIdUser, phoneTest, submitCreate, submitEdit, submitDrop];
